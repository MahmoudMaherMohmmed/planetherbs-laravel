...
class StrategyController extends Controller
{
    ...
    {
        $items = Strategy::all();
        return view('admin.strategies.index', compact('items'));
    }

    public function create()
    {
        return view('admin.strategies.edit');
    }
    ...
    {
        $item = Strategy::findorfail($id);
        return view('admin.strategies.edit', compact('item'));
    }
