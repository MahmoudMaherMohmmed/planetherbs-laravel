...
!function (t, e) {
    ...
    var r, a, l, c, u = function (t) {
        ...
        O = (l = new CustomEvent("Bootstrap", {cancelable: !0}), (c = document.createElement("div")).addEventListener("Bootstrap", (function () {
            return null
    ...
    var et = {
        ...
        st = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, rt = {
            ...
            return e.next = function () {
                ...
                var i = L(e, "bs.carousel"), o = s(s({}, st), et.getDataAttributes(e));
    ...
    var _t = "dropdown", vt = new RegExp("ArrowUp|ArrowDown|Escape"), bt = {
        ...
        return i.toggle = function () {
            ...
            if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                var n = e.getParentFromElement(this._element), i = {relatedTarget: this._element};
            ...
            if (!t || 2 !== t.button && ("keyup" !== t.type || "Tab" === t.key)) for (var n = nt.find('[data-toggle="dropdown"]'), i = 0, o = n.length; i < o; i++) {
                var s = e.getParentFromElement(n[i]), r = L(n[i], "bs.dropdown"), a = {relatedTarget: n[i]};
            ...
            if (!(/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu")) : !vt.test(t.key)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                var n = e.getParentFromElement(this), i = this.classList.contains("show");
    ...
    var Pt = "tooltip", xt = new RegExp("(^|\\s)bs-tooltip\\S+", "g"), Rt = ["sanitize", "whiteList", "sanitizeFn"],
        Ht = {
            animation: "boolean",
            template: "string",
            ...
            return i.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    var n = q.trigger(this.element, this.constructor.Event.SHOW), i = function t(e) {
                ...
                var t = this, e = this.getTipElement(), n = function () {
                    "show" !== t._hoverState && e.parentNode && e.parentNode.removeChild(e), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), q.trigger(t.element, t.constructor.Event.HIDDEN)
                };
                ...
                var t = this.getTipElement(), e = t.getAttribute("class").match(xt);
                ...
                return this.each((function () {
                    var n = L(this, "bs.tooltip"), i = "object" == typeof t && t;
    ...
    var Vt = "popover", qt = new RegExp("(^|\\s)bs-popover\\S+", "g"), zt = s(s({}, Ut.Default), {}, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
    }), Kt = s(s({}, Ut.DefaultType), {}, {content: "(string|element|function)"}), Xt = {
        ...
        return s.isWithContent = function () {
            ...
            var t = this.getTipElement(), e = t.getAttribute("class").match(qt);
            null !== e && e.length > 0 && e.map((function (t) {
                return t.trim()
            })).forEach((function (e) {
                return t.classList.remove(e)
    ...
    var ae = {animation: "boolean", autohide: "boolean", delay: "number"},
        le = {animation: !0, autohide: !0, delay: 500}, ce = function () {
            function t(t, e) {
