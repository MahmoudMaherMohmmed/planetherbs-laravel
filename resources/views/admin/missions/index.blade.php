...
@section('title') Home Missions @endsection
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Home Missions</li>
                    </ul>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    {{--<a href="{{ route('missions.create') }}" class="btn btn-success btn-icon float-right"><i
                                ...
                                <table
                                    ...
                                    @if(isset($items) && $items!=null)
                                        @foreach($items as $item)
                                            <tr>
                                                <td>{{$item->id}}</td>
                                                <td>{{getLangValue($item->title, 'ar')}}</td>
                                                <td>{{getLangValue($item->title, 'en')}}</td>
                                                <td>
                                                    ...
                                                    {{--<form action="{{ route('missions.destroy' , $item->id )}}"
                                                          method="POST"
