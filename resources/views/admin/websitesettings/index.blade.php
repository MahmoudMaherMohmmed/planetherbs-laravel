        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    {{--
                    <a href="{{ route('website-settings.create') }}" class="btn btn-success btn-icon float-right"><i
                                    ...
                                    @if(isset($items) && $items!=null)
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('website-settings.edit' , $item->id )}}">
                                                        <button class="btn btn-success"><i
                                                                class="zmdi zmdi-edit"></i></button>
                                                    </a>

                                                    {{--
                                                    <form action="{{ route('website-settings.destroy' , $item->id )}}"
                                                          method="POST"
