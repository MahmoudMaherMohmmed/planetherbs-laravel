            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{isset($item) ? 'Edit country' : 'New country'}}</li>
                    </ul>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <a href="{{route('countries.index')}}" class="btn btn-warning btn-icon float-right"><i
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="form_advanced_validation"
                                  ...
                                  method="POST"
                                  action="{{ isset($item) ? route('countries.update',$item->id) : route('countries.store') }}"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <input type="text" class="form-control" name="sortname"
                                                   value="{{ isset($item) ? $item->sortname : old('sortname') }}"
                                                   placeholder="Sort Name" required>
                                        </div>
                                    </div>
                                </div>
