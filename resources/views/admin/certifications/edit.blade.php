            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{isset($item) ? 'Edit Certification' : 'New Certification'}}</li>
                    </ul>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <a href="{{route('certifications.index')}}" class="btn btn-warning btn-icon float-right"><i
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="form_advanced_validation"
                                  ...
                                  method="POST"
                                  action="{{ isset($item) ? route('certifications.update',$item->id) : route('certifications.store') }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <input type="text" class="form-control" name="title_ar"
                                                   ...
                                                   placeholder="Certification Title-AR"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <input type="text" class="form-control" name="title_en"
                                                   ...
                                                   placeholder="Certification Title-EN"
                                                   minlength="3" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="description_ar"
                                                      placeholder="Certification Description-AR"
                                                      rows="4">{{ isset($item) ? getLangValue($item->description, 'ar') : old('description_ar') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="description_en"
                                                      placeholder="Certification Description-EN"
                                                      rows="4">{{ isset($item) ? getLangValue($item->description, 'en') : old('description_en') }}</textarea>
                                        </div>
                                    </div>
                                </div>
