...
@section('title') Home Services @endsection
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{isset($item) ? 'Edit Service' : 'New Service'}}</li>
                    </ul>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <a href="{{route('services.index')}}" class="btn btn-warning btn-icon float-right"><i
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="form_advanced_validation"
                                  ...
                                  method="POST"
                                  action="{{ isset($item) ? route('services.update',$item->id) : route('services.store') }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="description_ar"
                                                      placeholder="Services Description-AR"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea type="text" class="form-control" name="description_en"
                                                      placeholder="Services Description-EN"
